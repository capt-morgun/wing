...
- Конвертирует текст по реальным позициям клавиш (не по захардкоженной таблице символов), поэтому работает с любой парой раскладок
- Повторное двойное нажатие Shift переключает на следующую раскладку, если их больше двух
